                ...
                >
                    <Toolbar>
                        ...
                        <Box>
                            <NavLink
                                to={
                                    !Object.keys(info.payment).length === 0 ? "/payments" :
                                        !Object.keys(info.guestDetails).length === 0 ? "/guest-details" :
                                            info.filters.reservationDates.start && info.filters.reservationDates.end ? "/room-selection" :
                                                "/"
                                }
                            >
                                <Button
