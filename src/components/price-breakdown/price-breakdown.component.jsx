...
import { Box, Card, Divider, Fade, Grid, Slide, Typography } from "@material-ui/core";
    ...
    return (<>
        <Box sx={{
            ...
            <Fade in={props.priceBreakdownOpen}>
                <Box onClick={() => props.setPriceBreakdownOpen(false)} sx={{
                ...
                <Card sx={{
                    ...
                    <Box p={4}>
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={6}>
                                <Typography variant="priceBreakdownTitle" sx={{ fontWeight: Theme.typography.bold }}>
                                    Deluxe Sea View
                                </Typography>
                            </Grid>
                            ...
                            <Grid item xs={12} sx={{ display: "flex", justifyContent: "flex-end", alignItems: "center" }}>
                                ...
                                <Typography variant="priceBreakdownTitlePrice" sx={{ FontSize: 20 }}>
                                    ₱ {parseInt(info.roomSelection.totalPayment).toLocaleString()}.00
                                </Typography>
                            </Grid>
                        </Grid>
                    </Box>
