...
const Intro = () => {
  const { info, setInfo } = useContext(AppContext),
    ...
    chips = [
      'Relax in Elegance and Comfort',
      'Wine & Dine to Drinks and Dishes',
      'Experience Endless Fun and Leisure',
      'Celebrate Festivities & Gatherings with Us',
    ]
  ...
  return (
    <>
            ...
            <Box px={6}>
              ...
              <Box>
                <Typography variant="introSubtitle">
                  Explore an unparalleled sense of leisure with rejuvenating
                  offerings and dive into limitless play, water activities,
                  alfresco bar and dining, notable accommodations, and momentous
                  celebrations.
                </Typography>
              </Box>
      ...
      >
        <Button variant="navigationButton">
          <Box px={2} py={1} onClick={() => setFilterOpen(true)}>
            Book Now
          </Box>
        </Button>
      </Box>
